<?php
    ...
    $args = array(
        ...
        'menu_title'           => __( 'My New Theme', 'redux-framework-demo' ),
        'page_title'           => __( 'My New Theme', 'redux-framework-demo' ),
    ...
    Redux::setSection( $opt_name, array(
        'title'            => __( 'My Own', 'redux-framework-demo' ),
        'id'               => 'myown',
        'desc'             => __( 'My own menu items', 'redux-framework-demo' ),
        'customizer_width' => '400px',
        'icon'             => 'el el-home'
    ) );
    
    Redux::setSection( $opt_name, array(
        'title'            => __( 'First Menu', 'redux-framework-demo' ),
        'id'               => 'myown-firstmenu',
        'subsection'       => true,
        ...
        'fields'           => array(
            ...
            array(
                ...
                'desc'     => __( 'Upload image for the logo', 'redux-framework-demo' ),
